...
class RestTransactionControllerTest {
    ...
    void checkNewest() throws IOException, ParseException, CsvException {
        ...
        String[] actualResult =service.newerTransaction("TestData",null,null,null);
        assertThat(actualResult[0].equals(testResult[0]) && actualResult[1].equals(testResult[1]) && actualResult[2].equals(testResult[2]) && actualResult[3].equals(testResult[3]));
    }
    ...
    void checkNewestTInRange() throws IOException, ParseException, CsvException {
        ...
        String[] actualResult =service.newerTransaction("TestData",null,dates.getDateFrom(),dates.getDateTo());
        assertThat(actualResult[0].equals(testResult[0]) && actualResult[1].equals(testResult[1]) && actualResult[2].equals(testResult[2]) && actualResult[3].equals(testResult[3]));
    }
